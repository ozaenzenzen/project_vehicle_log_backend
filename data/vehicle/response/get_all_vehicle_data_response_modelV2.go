...
type DataGetAllVehicleV2 struct {
	...
	// MeasurementTitle *[]pq.StringArray `db:measurment_title json:"measurment_title"`
	// MeasurementTitle []uint8 `json:"measurment_title"`
	// MeasurementTitle *[]uint8 `json:"measurment_title"`
	// MeasurementTitle *[]string `json:"measurment_title"`
	// MeasurementTitle *string `json:"measurment_title"`
	MeasurementTitle any `json:"measurment_title"`
}
